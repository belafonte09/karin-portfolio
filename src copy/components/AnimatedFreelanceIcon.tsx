...
const AnimatedFreelanceIcon: React.FC = () => {
  return (
    <div className="relative w-16 h-16 group">
      ...
      {/* Static Freelance logo - stays on top and stationary */}
      <img
        src="/images/icons/freelance-icon.png"
        alt="Freelance Logo"
...
export default AnimatedFreelanceIcon;